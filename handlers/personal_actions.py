...
async def start(message: types.Message):
    ...
    await message.bot.send_message(message.from_user.id, "Добро пожаловать! Список команд: /spent(потрачено), /earned(заработана), /history(история). После написания команды впишите сумму, к прииеру: /spent 1000")
